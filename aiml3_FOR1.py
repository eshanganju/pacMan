...
# Output:
ofl='/home/eg/Desktop/Al-AM-samples/output/finalAnalysis-1/'
...
solidLabelMap = tf.imread('/home/eg/Desktop/Al-AM-samples/output/finalAnalysis-1/sample1-CROP-MEDIAN_1-Solid_OTSUdist-watershed.tif').astype('uint16')
voidLabelMap = tf.imread('/home/eg/Desktop/Al-AM-samples/output/finalAnalysis-1/sample1-CROP-MEDIAN_1-Void_OTSUdist-watershed.tif').astype('uint16')

solidEDM = tf.imread('/home/eg/Desktop/Al-AM-samples/output/finalAnalysis-1/sample1-CROP-MEDIAN_1-Solid_OTSU-EDM.tif')
voidEDM = tf.imread('/home/eg/Desktop/Al-AM-samples/output/finalAnalysis-1/sample1-CROP-MEDIAN_1-Void_OTSU-EDM.tif')
