...
# Euclid-Marker-Topo
s.euclidDistanceMap( superCube )

# Particle markers
s.localhMaxima( superCube, 4 )

# Watershed [HERE]
s.topoWatershed( superCube )

# Update particles after manual editing in imageJ
superCube.labelledMap = tiffy.imread( 'watershedSegmentation-edited-NE.tif' ) 
