...
# Output:
ofl='/home/eg/Desktop/Al-AM-samples/output/finalAnalysis/'
...
solidLabelMap = tf.imread('/home/eg/Desktop/Al-AM-samples/output/finalAnalysis/sample2-CROP-BIN-Solid156dist-watershed.tif').astype('uint16')
voidLabelMap = tf.imread('/home/eg/Desktop/Al-AM-samples/output/finalAnalysis/sample2-CROP-BIN-VOID155dist-watershed.tif').astype('uint16')

solidEDM = tf.imread('/home/eg/Desktop/Al-AM-samples/output/finalAnalysis/sample2-CROP-BIN-Solid156-dist.tif')
voidEDM = tf.imread('/home/eg/Desktop/Al-AM-samples/output/finalAnalysis/sample2-CROP-BIN-VOID155-dist.tif')
